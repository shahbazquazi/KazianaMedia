...
function Navbar() {
  ...
  return (
    <div>
      <nav className="fixed bg-transparent text-metallicGoldS w-screen h-24 z-30 max-[820px]:bg-black">
        <div className="grid grid-cols-2">
          <div className="flex justify-start items-end ml-5 h-20">
            <Link href="/">
            <img src="/logo.svg" alt="Traffkey" className="h-10 m-5" />
            </Link>
          </div>
